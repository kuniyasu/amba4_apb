...
class TargetDUT:public sc_module, public apb4_interface<32U,32U>{
public:
	sc_in<bool> clk;
	sc_in<bool> nrst;

	apb4_export<32U,32U,ioMode> ex_port;
	...
	typedef apb4_interface<32U,32U> if_type;
...
public:
	...
	TargetDUT targetDUT;
	apb4_simple_bus<32U,32U,ioMode> bus;
