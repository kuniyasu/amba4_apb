...
public:
	...
	apb4_base_chain(const char* name=sc_gen_unique_name("apb4_base_chain")):
...
public:
	...
	apb4_base_port(const char* name=sc_gen_unique_name("apb4_base_port")):
	psel( PIN_NAME(name,"psel" )),
	paddr(PIN_NAME(name,"paddr")),
	pprot(PIN_NAME(name,"pprot")),
	penable(PIN_NAME(name,"penable")),
	...
	void bind(apb4_base_port<ADWIDTH,BUSWIDTH,MODE>& c){
		psel(c.psel);
		paddr(c.paddr);
		pready(c.pready);
		pprot(c.pprot);
...
public:
	...
	apb4_base_export(const char* name=sc_gen_unique_name("apb4_base_export")):
	psel( PIN_NAME(name,"psel" )),
	paddr(PIN_NAME(name,"paddr")),
	pprot(PIN_NAME(name,"pprot")),
	penable(PIN_NAME(name,"penable")),
	...
	void bind(apb4_base_export<ADWIDTH,BUSWIDTH,MODE>& c){
		psel(c.psel);
		paddr(c.paddr);
		pready(c.pready);
		pprot(c.pprot);
...
template<unsigned int ADWIDTH, unsigned int BUSWIDTH, class MODE=PIN>
class apb4_port:public sc_module, public apb4_base_port<ADWIDTH,BUSWIDTH,MODE>, public apb4_interface<ADWIDTH,BUSWIDTH>{
public:
	typedef sc_uint<BUSWIDTH> data_type;
	...
	typedef apb4_base_port<ADWIDTH,BUSWIDTH,MODE> base_class;

	sc_in<bool> pclk;
	sc_in<bool> nreset;

	apb4_port(sc_module_name name=sc_gen_unique_name("apb4_port")):sc_module(name),pclk("pclk"),nreset("nreset"){
		end_module();
	}
	...
	void operator()(apb4_base_chain<ADWIDTH,BUSWIDTH>& c){
		bind(c);
	}

	void operator()(apb4_base_port<ADWIDTH,BUSWIDTH,MODE>& c){
		bind(c);
	}
...
template<unsigned int ADWIDTH, unsigned int BUSWIDTH, class MODE=PIN>
class apb4_export:public sc_module, public apb4_base_export<ADWIDTH,BUSWIDTH,MODE>, public apb4_interface<ADWIDTH,BUSWIDTH>{
public:
	typedef sc_uint<BUSWIDTH> data_type;
	typedef sc_uint<BUSWIDTH/8> strb_type;
	typedef sc_uint<ADWIDTH> address_type;
	...
	typedef apb4_base_export<ADWIDTH,BUSWIDTH,MODE> base_class;
	typedef apb4_interface<ADWIDTH,BUSWIDTH> inf_type;
	...
	SC_HAS_PROCESS(apb4_export);

	apb4_export(sc_module_name name=sc_gen_unique_name("apb4_export")):sc_module(name),pclk("pclk"),nreset("nreset"){
	...
	void operator()(apb4_base_export<ADWIDTH,BUSWIDTH,MODE>& c){
		bind(c);
	}
...
template<unsigned int ADWIDTH, unsigned int BUSWIDTH, class MODE=PIN>
class apb4_simple_bus:public sc_module{
public:
	apb4_base_chain<ADWIDTH,BUSWIDTH> initiator_port;
	apb4_base_chain<ADWIDTH,BUSWIDTH> target_port;

	SC_HAS_PROCESS(apb4_simple_bus);

	apb4_simple_bus(sc_module_name name):sc_module(name),
...
template<unsigned int ADWIDTH, unsigned int BUSWIDTH>
class apb4_base_port<ADWIDTH,BUSWIDTH,TLM2LT>:public tlm_initiator_socket<BUSWIDTH>{
public:
...
template<unsigned int ADWIDTH, unsigned int BUSWIDTH>
class apb4_base_export<ADWIDTH,BUSWIDTH,TLM2LT>:public tlm_target_socket<BUSWIDTH>{
public:
...
template<unsigned int ADWIDTH, unsigned int BUSWIDTH>
class apb4_port<ADWIDTH,BUSWIDTH,TLM2LT>:public tlm_initiator_socket<BUSWIDTH>, public tlm_bw_transport_if<>, apb4_interface<ADWIDTH,BUSWIDTH>{
public:
	typedef tlm_initiator_socket<BUSWIDTH> base_type;
...
template<unsigned int ADWIDTH, unsigned int BUSWIDTH>
class apb4_export<ADWIDTH,BUSWIDTH,TLM2LT>:public tlm_target_socket<BUSWIDTH>, public tlm_fw_transport_if<>, apb4_interface<ADWIDTH,BUSWIDTH>{
public:
	typedef tlm_target_socket<BUSWIDTH> base_type;
	typedef apb4_interface<ADWIDTH,BUSWIDTH> inf_type;
...
template<unsigned int ADWIDTH, unsigned int BUSWIDTH>
class apb4_simple_bus<ADWIDTH,BUSWIDTH,TLM2LT>: public tlm_fw_transport_if<>, public tlm_bw_transport_if<>{
public:
	apb4_base_export<ADWIDTH,BUSWIDTH,TLM2LT> initiator_port;
	apb4_base_port<ADWIDTH,BUSWIDTH,TLM2LT> target_port;
